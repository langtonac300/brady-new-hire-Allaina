...
| `Library` | All 66 documents — orientation, learning material, every project brief. One row each, body included |
...
| **Search** | Full text, across all 66 documents *and* everything you have written |
...
> two of the 66 documents, so inlining all twelve would put 840 KB on every screen to show at
...
make, checks setup and re-import are idempotent, then renders all 66 documents and verifies the
